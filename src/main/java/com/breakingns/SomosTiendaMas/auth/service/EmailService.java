...
public class EmailService {
    ...
    public void enviarEmailVerificacion(String destinatario, String codigo) {
        ...
        if (EMAILS_BLOQUEADOS.contains(destinatario)) {
            // No enviar el correo, solo registrar el usuario o continuar el flujo
            System.out.println("\n\nNO SE ENVIA CORREO!!!!\n\n");
            return;
        }
        //----------------
        ...
        String html = "<div style='font-family: Arial, sans-serif; color: #333; background: #f9f9f9; padding: 24px; border-radius: 8px;'>"
            ...
            + "<div style='font-size: 2em; color: #388e3c; font-weight: bold; margin: 16px 0;'>" + codigo + "</div>"
            + "<img src='https://i.imgur.com/yourlogo.png' alt='Logo' style='width:120px; margin-top:16px;'/>"
        ...
        public void enviarEmailRecuperacionPassword(String destinatario, String codigo, String enlace) {
            // SOLO TEST
            if (EMAILS_BLOQUEADOS.contains(destinatario)) {
                // No enviar el correo
                return;
            ...
            try {
                ...
                String html = "<div style='font-family: Arial, sans-serif; color: #333; background: #f9f9f9; padding: 24px; border-radius: 8px;'>"
                    ...
                    + "<p>Solicitaste recuperar tu contraseña. Puedes usar el siguiente código o hacer clic en el enlace para restablecerla:</p>"
                    + "<div style='font-size: 2em; color: #388e3c; font-weight: bold; margin: 16px 0;'>" + codigo + "</div>"
