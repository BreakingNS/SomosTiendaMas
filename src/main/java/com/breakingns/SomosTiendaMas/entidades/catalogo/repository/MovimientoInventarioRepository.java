...
public interface MovimientoInventarioRepository extends JpaRepository<MovimientoInventario, Long> {
    ...
    Optional<MovimientoInventario> findFirstByOrderRefAndTipoAndVarianteId(String orderRef, TipoMovimientoInventario tipo, Long varianteId);
    ...
    List<MovimientoInventario> findByVarianteId(Long varianteId);
