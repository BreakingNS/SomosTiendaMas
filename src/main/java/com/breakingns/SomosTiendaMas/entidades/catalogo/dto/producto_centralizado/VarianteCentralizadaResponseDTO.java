...
public class VarianteCentralizadaResponseDTO {
    private Long id;
    private String sku;
    ...
    private VarianteConOpcionesValoresDTO varianteOpciones;
    private List<PrecioVarianteResponseDTO> precios;
    private List<InventarioVarianteDTO> inventarios;
    private List<com.breakingns.SomosTiendaMas.entidades.catalogo.dto.producto_centralizado.PhysicalPropertiesDTO> physical;
    ...
    public VarianteConOpcionesValoresDTO getVarianteOpciones() { return varianteOpciones; }
    public void setVarianteOpciones(VarianteConOpcionesValoresDTO v) { this.varianteOpciones = v; }
    ...
    public List<com.breakingns.SomosTiendaMas.entidades.catalogo.dto.producto_centralizado.PhysicalPropertiesDTO> getPhysical() { return physical; }
    public void setPhysical(List<com.breakingns.SomosTiendaMas.entidades.catalogo.dto.producto_centralizado.PhysicalPropertiesDTO> physical) { this.physical = physical; }
